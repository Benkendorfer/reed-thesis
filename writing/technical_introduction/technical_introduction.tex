...
\section{Quantum Chromodynamics (QCD)}\label{technical-sec:QCD}
	...
	\begin{equation}
		\partial^2 A^\nu = e\bar \psi \gamma^\nu \psi,
	\end{equation}
	which, as a first-order differential equation, reveals the familiar fact that electromagnetism obeys the principle of superposition \cite{larkoski_elementary_2019-1} {\color{red}\textbf{[TODO: CHECK SCHWARTZ]}}. In contrast, the field strength tensor for QCD is \cite{larkoski_elementary_2019-1}
